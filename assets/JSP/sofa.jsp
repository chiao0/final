...
<head>
  ...
  <body>
    ...
    <nav>
      <a href="desk.html">書桌</a>
      <a href="chair.html">椅子</a>
      <a href="cabinet.html">櫃子</a>
      <a href="sofa.html">沙發</a>
    </nav>
   ...
   <%
                try {
                    ...
                    if (con.isClosed()) {
                        ...
                        String sql = "SELECT `id`, `imgstyle`, `src`, `productname` FROM `new product` WHERE `id` BETWEEN 1 AND 5";
